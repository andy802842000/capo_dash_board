...
import { GameNameList, YULE_GAMES } from "../../../../config/config";

interface RenderGameTableProps {
  handleOpenLink: (gameId: string) => void;
}

const YuleGameTable: React.FC<RenderGameTableProps> = ({ handleOpenLink }) => {
  return (
